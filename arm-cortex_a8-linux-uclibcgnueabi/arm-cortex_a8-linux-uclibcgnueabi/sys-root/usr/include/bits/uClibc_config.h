...
#define __KERNEL_HEADERS__ "/home/gilsken/x-tools/arm-cortex_a8-linux-uclibcgnueabi/arm-cortex_a8-linux-uclibcgnueabi//sys-root/usr/include"
...
#define __UCLIBC_EXTRA_CFLAGS__ " -march=armv7-a -mcpu=cortex-a8 -mtune=cortex-a8 -mfpu=neon -O3 -Os"
#undef __DODEBUG__
